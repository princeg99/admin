...
const index$1 = require("./index-SDJgON5S.js");
...
const ListView$1 = React.lazy(() => Promise.resolve().then(() => require("./ListView-B-HL7krE.js")));
const RecursivePath = () => {
...
const ListView = React.lazy(() => Promise.resolve().then(() => require("./ListView-B-HL7krE.js")));
const App = () => {
  const { formatMessage } = reactIntl.useIntl();
...
//# sourceMappingURL=index-DoD5A25S.js.map
