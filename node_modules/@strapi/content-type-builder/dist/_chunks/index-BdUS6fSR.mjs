...
const ListView$1 = lazy(() => import("./ListView-CpLjBWJ4.mjs"));
const RecursivePath = () => {
...
const ListView = lazy(() => import("./ListView-CpLjBWJ4.mjs"));
const App = () => {
  const { formatMessage } = useIntl();
...
//# sourceMappingURL=index-BdUS6fSR.mjs.map
